...
JiraData.getSprintTeams = function(sprint, callback) {
    ...
    get(pathname, query, function(data) {
        var fieldData = JSON.parse(data);
        var uniqueTeams = fieldData.projects[0].issues.fields.customfield_11702;
        //var uniqueTeams = _.chain(fieldData).map(function(issues) { return issues.fields.customfield_1170; }).uniq().value();
